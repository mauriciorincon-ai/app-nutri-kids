...
export const en: Dictionary = {
  ...
  today: {
    ...
    addNote: "Add note",
    editNote: "Edit note",
    noteFor: "Note for {item}",
    noteChipRejected: "Refused it",
    noteChipPain: "Had pain",
    noteChipCraving: "Had a craving",
    noteChipOther: "Something else",
  ...
  reminder: {
    heading: "Right now",
    loading: "Checking what's up…",
    mealNow: "Time for {meal}",
    mealBeforeFirst: "The day starts with {meal}, at {time}",
    mealBetween: "A breather between meals",
    mealAfterLast: "Today's last meal was {meal}",
    next: "Next: {meal} · {time}",
    supplementDue: "Today's supplement: {names}",
    supplementsDone: "Today's supplement: done",
    noSupplement: "No supplement today",
    water: "Water: {done} of {target} glasses",
  },
  history: {
    title: "Previous days",
    intro:
      "A look at what was recorded on other days. Just to check; not editable.",
    empty:
      "No recorded days yet. As you check things in “Today”, they'll show up here.",
    todayTag: "Today",
    noteLabel: "Note:",
    at: "at {time}",
    timeUnknown: "no time",
  ...
  chat: {
    title: "Ask the diet",
    intro: "Write like you'd talk to someone. Two ways it answers:",
    emptyHint: "Try one of these:",
    sugg1: "Can he have apples?",
    sugg2: "What snack can I give?",
    sugg3: "I have no chicken, what can I give?",
    inputPlaceholder: "Type your question…",
    send: "Send",
    sending: "Sending…",
    thinking: "Thinking…",
    fromPlanBadge: "From your plan · no AI",
    aiBadge: "AI answer",
    aiDisclaimer:
      "Generated by AI from your plan. Check it with your professional.",
    replacementsTitle: "If it's missing, use…",
    additiveTitle: "Additive to avoid",
    additiveFoundIn: "Usually found in: {where}",
    restrictedUntil: "On a break until {date}",
    restrictionEnded: "The break is over — check with the professional.",
    errorTitle: "The assistant is unavailable",
    errorBody:
      "We couldn't reach the assistant right now. Quick “can he have?” checks still work.",
    disabledTitle: "The assistant is paused",
    disabledBody:
      "The AI part is off for now. You can still ask “can he have apples?” and I'll answer instantly from your plan.",
    introTitle: "How this chat works",
    introBody:
      "“Can he have?” questions are answered instantly from your plan, right here on the phone. For more open questions, an AI reads your plan (with the kid's name hidden) and answers only with what the plan allows. It is not medical advice.",
    introAccept: "Got it",
    aiDot: "AI assistant",
  },
  detail: {
  ...
  settings: {
    ...
    clearBody:
      "Deletes the loaded diet and your whole day record (checkmarks, times and notes) from this device. The app returns to the demo.",
    clearButton: "Delete my data",
    clearConfirmTitle: "Delete everything?",
    clearConfirmBody:
      "The loaded diet and the whole day record (checkmarks, times and notes) will be deleted. This cannot be undone.",
    ...
    aiTitle: "Chat AI assistant",
    aiBody:
      "When you ask an open question in the chat, your plan (with the kid's name hidden) is sent to an AI provider to draft the answer. “Can he have?” questions are answered on the phone, without leaving it. None of the conversation is saved or logged.",
    aiStatusEnabled: "AI assistant: on",
    aiStatusDisabled: "AI assistant: paused",
  },
  a11y: {
