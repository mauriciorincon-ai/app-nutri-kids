...
export const es = {
  ...
  settings: {
    ...
    clearBody:
      "Borra la dieta cargada y las marcas del día de este dispositivo. La app vuelve a la demo.",
    clearButton: "Borrar mis datos",
    clearConfirmTitle: "¿Borrar todo?",
    clearConfirmBody:
      "Se borrará la dieta cargada y el historial de marcas. Esto no se puede deshacer.",
